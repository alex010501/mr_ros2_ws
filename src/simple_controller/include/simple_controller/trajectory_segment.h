...
namespace trajectory
{
    ...
    public:
        ...
        CircularSegment(double c, double x, double y, double vx, double vy, double l) : curvature(c),
                                                                                        x0(x, y, 0),
                                                                                        v(vx, vy, 0),
                                                                                        length(l),
                                                                                        start_angle((curvature > 0) ? atan2(-v.x(), v.y()) : atan2(v.x(), -v.y())), // vector from center to first point (vy -vx) or (-vy, vx)
    ...
    public:
        ...
        LinearSegment(double x, double y, double vx, double vy, double l) : x0(x, y, 0), v(vx, vy, 0), length(l)
        {
        }
    };
